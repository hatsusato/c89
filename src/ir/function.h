...
void ir_function_terminate_prev(struct json *, struct json *);
void ir_function_set_break(struct json *, struct json *);
struct json *ir_function_get_break(struct json *);
